...
if [[ $TYPE = "neovim" ]]; then
    ...
    git clone "$PACKER_NVIM" "$HOME/.config/nvim/pack/packer/start/packer.nvim" && \
        echo -e "${GREEN}packer.vim installed at $HOME/.config/nvim/pack/packer/start/packer.nvim${NC}"
fi
